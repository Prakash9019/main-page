...
const Main = () => {
  return (
    ...
    <div class="para1">
        ...
        <div class="p1right">
            <p class="p1">"Medicines cure diseases,Doctors cure patients"<br/>
                                                           -Carl Jung
            </p>
        </div>
    </div>
    ...
    <div class="para">
        ...
        <div class="pleft">
           <p class="p1">The major problem with carrying the health records is it can be lost anytime and in the time of need ,the
tests need to be performed again.E- health record is like digital version of a patients paper chart. EHRs are
real-time, patient-centered records that make information available instantly and securely to authorized users.</p>
        </div>
