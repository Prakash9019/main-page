  ...
  return (
    ...
    <div className="left-layout">
        <div className="left-section-link">
            ...
            <div className="vital" onclick={'/vital_sign/vitalsigns.html'}>Vital Signs</div>
            <div className="lab-test" to="/labtests_and_reports/labtests.html">Lab tests</div>
            <Link className="Medical" to="/hiiii">Medical Records</Link>
